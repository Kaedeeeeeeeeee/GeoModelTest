...
public class DroneController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log($"无人机控制器已启动: {gameObject.name}");
    }
    ...
    void StartControlling(FirstPersonController player)
    {
        ...
        Debug.Log($"玩家开始控制无人机: {gameObject.name}");
    }
    ...
    void StopControlling()
    {
        ...
        if (lookDirection != Vector3.zero)
        {
            ...
            if (horizontalDirection != Vector3.zero)
            {
                ...
                Debug.Log($"设置玩家朝向无人机: {horizontalDirection}");
            }
            ...
            if (playerCamera != null)
            {
                ...
                if (fpController != null)
                {
                    ...
                    if (xRotationField != null)
                    {
                        ...
                        Debug.Log($"设置摄像机向上看角度: {lookUpAngle}°");
                    }
                }
        ...
        Debug.Log($"玩家从无人机下车，位置: {exitPosition}");
    ...
    void SetupThirdPersonCamera()
    {
        ...
        Debug.Log($"无人机摄像机设置到世界位置: {cameraWorldPos}");
    }
    ...
    void CheckGroundStatus()
    {
        ...
        if (Physics.Raycast(rayStart, Vector3.down, out RaycastHit hit, groundCheckDistance, groundLayers))
        {
            ...
            {
                Debug.Log("无人机已着陆 - 需要先升空才能使用WASD移动");
            }
        }
        else
        {
